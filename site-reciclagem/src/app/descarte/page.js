export default function DescartePage() {
  return (
    <section className="conteudo">
      ...
      <ul className="custom">
        <li>Celulares, tablets e computadores</li>
        <li>Pilhas, baterias e carregadores</li>
        <li>TVs, rádios e eletrodomésticos pequenos</li>
      </ul>
      <h2>Por Que o Descarte Correto é Importante?</h2>
      <ul className="custom">
        <li>Evita a poluição do meio ambiente</li>
        <p>Esses aparelhos têm substâncias tóxicas como chumbo, mercúrio e cádmio. Quando são jogados no lixo comum, essas substâncias podem vazar e contaminar o solo, a água e o ar.</p>
        <li>Protege a saúde das pessoas</li>
        <p>Se não forem descartados corretamente, os produtos eletrônicos podem causar doenças sérias, como problemas respiratórios, câncer e danos neurológicos, principalmente em quem lida com esse lixo de forma incorreta.</p>
        <li>Permite a reciclagem de materiais</li>
        <p>Muitos eletrônicos têm metais valiosos como cobre, prata e até ouro. Ao reciclá-los, é possível reutilizar esses materiais e reduzir a exploração da natureza. </p>
        <li>Evita desperdícios e ajuda a economia</li>
